...
const Color itemViewBorderColor = Color(0xffFEEFDF);
const Color addToBagColor = Color(0xffFFFCEE);
List<Color> listGradColor = [const Color(0xffD1A582).withOpacity(0.25), const Color(0xffFFFFFF).withOpacity(0), const Color(0xffD1A582).withOpacity(0.25)];
...
const String enBold = "LexendGigaBold";
const String enSemiBold = "LexendGigaSemiBold";
const String enMedium = "LexendGigaMedium";
